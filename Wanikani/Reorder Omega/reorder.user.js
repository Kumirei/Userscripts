...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    // -----------------------------------------------------------------------------------------------------------------
    function get_bell_audio() {
        var base64BellAudio = localStorage.getItem("".concat(script_id, "_burn_bell_base64_audio"));
        if (!base64BellAudio) {
            if (settings.burn_bell === 'high') {
                ...
                return new Audio("data:audio/mp3;base64,".concat(base64BellAudio));
            }
                ...
                return new Audio("data:audio/wav;base64,".concat(base64BellAudio));
            }
        }
        var audio = new Audio("data:audio/mp3;base64,".concat(base64BellAudio));
        return audio;
    }
    var script_id, script_name, wkof, $, WaniKani, MS, page, current_item_key, active_queue_key, inactive_queue_key, question_type_key, UID_prefix, egg_timer_location, preset_selection_location, settings, settings_dialog, items_by_id, original_queue, completed, _a, burn_bell_audio;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
