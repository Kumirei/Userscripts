...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    function add_to_extra_study_section() {
        var _a, _b, _c;
        var attr = (_a = document.querySelector('.extra-study')) === null || _a === void 0 ? void 0 : _a.getAttribute('data-react-props');
        if (!attr)
            return;
    ...
    var script_id, script_name, wkof_version_needed, wkof, wkQueue, streak, MS, page, header_row_location, preset_selection_location, settings, settings_dialog, burn_bell_audio, burn_bell_audio_sources, body;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
