...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    function update_bell_audio() {
        ...
        if (custom_base_64_bell)
            ...
            burn_bell_audio.src = high_pitched_bell;
        else if (settings.burn_bell === 'low')
            burn_bell_audio.src = low_pitched_bell;
    }
    var script_id, script_name, wkof, $, WaniKani, MS, page, current_item_key, active_queue_key, inactive_queue_key, question_type_key, UID_prefix, egg_timer_location, preset_selection_location, settings, settings_dialog, items_by_id, original_queue, completed, _a, burn_bell_audio, high_pitched_bell, low_pitched_bell;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
