...
;(function () {
    var countdowns = [
        ...
        //{title: "", date: "", user: "", message0: "", message1: "", modifier: "", extra: ""},
        {
            title: 'Thubanshee does her absolute best on the N1',
            date: 'dec 1 2024',
            user: 'Thubanshee',
            message0: '',
            message1: '',
        ...
        {
            title: 'Beyond_Sleepy goes to Japan',
            date: 'oct 3 2024',
            user: 'Beyond_Sleepy',
            message0: "@Beyond_Sleepy Prepare your nihongos, because you're gonna need them!",
            message1: '@Beyond_Sleepy AAAAAAA HAVE FUN!!',
            modifier: '',
            extra: '',
        },
        {
        ...
        {
            title: "NeoArcturus's History and Latin Exams start",
            date: 'mar 20 2024',
            user: 'NeoArcturus',
            message0: '',
            message1: '',
        ...
        },
        {
            ...
            date: 'dec 1 2024',
            user: 'trickster-saf',
            message0: '@trickster-saf @Thubanshee get your pencils ready!',
            message1: '@trickster-saf @Thubanshee you did it!!!!',
            modifier: '',
            extra: '',
        },
        {
            ...
            date: 'jul 7 2024',
            user: 'aanhlle',
            message0: '@aanhlle @nafets Get your pencils ready!',
            message1: '@aanhlle nafets Did you do it?!',
            modifier: '',
            extra: '',
        },
        {
            title: 'Nafets crushes the N3',
            date: 'jul 7 2024',
            user: 'nafets',
            message0: '',
            message1: '',
        ...
        },
        {
            ...
            date: 'oct 13 2025',
            user: 'mortiii',
            message0: '@mortiii did you get to go?',
            message1: "@mortiii aaaand it's over",
            modifier: '',
            extra: '',
        },
        {
            title: 'World Expo 2025 in Osaka (2025年日本国際博覧会)',
            date: 'apr 13 2025',
            user: 'mortiii',
            message0: '@mortiii Got your tickets ready?',
            message1: '@mortiii here we go!',
            modifier: '',
            extra: '',
        },
        {
