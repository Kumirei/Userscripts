...
(function($, wkof, review_cache, Heatmap) {
    ...
    function create_popper(data) {
        ...
        stats.append(create_table('left', [["Levels"], [" 1-10", 0], ["11-20", 0], ["21-30", 0], ["31-40", 0], ["41-50", 0], ["51-60", 0]], {class: 'levels'}, true),
    ...
    function create_view(type, stats, level_ups, first_date, data) {
        ...
        let heatmap = new Heatmap({type: "year",
                                   id: type,
    ...
    function create_stats_elements(type, stats) {
        ...
        let foot_stats = create_elem({type: 'div', class: 'foot-stats stats', children: [
            ...
            create_stat_element(type.toProper(), stats.total[0].toSeparated(), create_table("left", [['This Year', stats.total[1].toSeparated()],
                                                                                                     ['This Month', stats.total[2].toSeparated()],
                                                                                                     ['This Week', stats.total[3].toSeparated()],
                                                                                                     ['Today', stats.total[4].toSeparated()]
                                                                                                    ])),
            create_stat_element('Time', m_to_hm(stats.time[0]), create_table("left", [['This Year', m_to_hm(stats.time[1])],
